...
import 'package:task_appointments/bloc/login/login_bloc.dart';
...
class _LoginState extends State<Login> {
  ...
  Widget build(BuildContext context) {
    ...
    var viewHeight = MediaQuery.of(context)
        .size
        .height; // Using this line I got the device screen height
    // SystemChrome.setSystemUIOverlayStyle(SystemUiOverlayStyle.light
    //     .copyWith(statusBarColor: CustomColors.backGroundColor));
    return Scaffold(
      key: _scaffoldkey,
      body: SafeArea(
        child: Container(
                        ...
                        child: BlocListener<LoginBloc, LoginState>(
                          ...
                          onPressed: () {
                            if(textEditingController1.text.isNotEmpty&&textEditingController2.text.isNotEmpty){
                              ...
                              BlocProvider.of<LoginBloc>(context).add(LoginUser(loginInput: LoginInput(isMobile: true, email: "null", mobileNo: textEditingController1.text, password:"${hash}" , hashValue: "${hash1}")));
                            }
                            else{
                                ScaffoldMessenger.of(context).showSnackBar(
                                    SnackBar(
